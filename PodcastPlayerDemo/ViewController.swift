...
class ViewController: UIViewController {
    ...
    var items: [PlayerItem] = [
        PlayerItem(itemURL: URL(string: "https://www.thepodcastexchange.ca/s/AlanCross-Porter-v2.mp3")!, thumbnailURL: URL(string: "http://vocaro.com/trevor/blog/wp-content/uploads/2009/10/Resize-with-interpolation.jpg"), albumName: nil, trackName: nil),
        PlayerItem(itemURL: URL(string: "https://www.thepodcastexchange.ca/s/McDonalds_LNG_061019.wav")!, thumbnailURL: nil, albumName: nil, trackName: nil),
